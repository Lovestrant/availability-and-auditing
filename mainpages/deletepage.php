<?php 
    ...
    if(isset($_POST['deletepost'])){
        ...
        $sql1="SELECT * FROM authentication where id = '$postid'";
        ...
        if($queryResults) {
            ...
            $sql = "INSERT INTO backup (fullname, phonenumber,securitykey, password) VALUES ('$fullname', '$phonenumber','$securitykey','$password')";
		    $res = mysqli_query($con,$sql);
		
	
		 if($res ==1){
            $sql="DELETE FROM authentication where id = '$postid'";
...
<div class="container">
     ...
     <?php 
        ...
        $postId = $_GET['postId'];
            ...
            $sql="SELECT * FROM authentication where id ='$postId'";
...
<div class="row" style="margin: 3%;">
 <div class="col-sm-12">
    ...
    <input type="hidden" name= "hiddenid" value=<?php $id= $_GET['postId']; echo $id; ?>> <!-- Hidden input-->
     ...
     <button name="deletepost" style="background-color: red;color:white;">Delete Above Record</button>
    </form>
